...
if __name__ == '__main__':
    ...
    parser.add_argument('--which_epoch', default='last', type=str, help='0,1,2,3...or last best')
    parser.add_argument('--data_dir', default='../data/Market/pytorch',type=str,
                        help='./test_data') #  cuhk03_release  Market
    # parser.add_argument('--data_dir', default='../data/Market/pytorch', type=str,
    #                     help='./test_data')
    ...
    parser.add_argument('--stage', default='full', type=str, choices={'full','PCB','RPP'}, help='stage')
    ...
    parser.add_argument('--feature_H', action='store_true', help='extract feature_H', default=False)
